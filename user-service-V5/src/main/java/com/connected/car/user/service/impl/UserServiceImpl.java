...
//	}
	...
	public UserDto createUser(UserDto userDto) {
		...
		userDto.setRole(List.of(Roles.user));
...
//		HttpEntity<String> request = new HttpEntity<>(headers);
	...
	@Override
	public boolean updateRole(String email, List<Roles> role) {
		UserDto u = getUserByEmail(email);
		u.setRole(role);
		User updatedUser = userRepository.save(dtoToEntity(u));
		System.out.println("In user service imp class update role method "+updatedUser.getRole());
		boolean success=keycloakUserService.updateRole(email,role);
		return success;

	}

	@Override
	public boolean updateRoleToUser(String email, List<Roles> role) {
		UserDto u = getUserByEmail(email);
		u.setRole(role);
		User updatedUser = userRepository.save(dtoToEntity(u));
		System.out.println("In user service imp class update roleToAdmin method "+updatedUser.getRole());
		boolean success=keycloakUserService.updateRoleToUser(email,role);
		return success;
	}
